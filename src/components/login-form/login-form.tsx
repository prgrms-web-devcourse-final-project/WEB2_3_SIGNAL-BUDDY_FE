...
<div className="flex items-center justify-between mt-5">
        ...
        <div className="flex-grow border-t border-gray-300"></div>
              ...
              <div className="flex justify-center gap-5 mt-[18px]">
                ...
                <Button variant="outline" className="w-10 h- flex items-center justify-center rounded-full bg-white border-gray-300">
          ...
          <div className="relative hidden bg-muted md:block ">
            <Image src={loginBackground} alt="login background image" fill className="object-cover"/>
